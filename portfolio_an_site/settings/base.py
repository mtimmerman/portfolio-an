...
import portfolio_an_site
VERSION = portfolio_an_site.__version__
...
SECRET_KEY = '&fds1@z8p9drk8rc7d2tyj$z*zmdb0&f$v@bp9t4!wz^*8x8wf'
...
WSGI_APPLICATION = 'portfolio_an_site.wsgi.application'

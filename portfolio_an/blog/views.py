...
from portfolio_an.blog.models import *
...
def delete_comment(request, post_pk, pk=None):
    ...
    if request.user.is_staff:
        ...
        return HttpResponseRedirect(reverse("portfolio_an.blog.views.post", args=[post_pk]))
...
def add_comment(request, pk):
    ...
    return HttpResponseRedirect(reverse("portfolio_an.blog.views.post", args=[pk]))
